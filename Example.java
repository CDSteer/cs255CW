...
public class Example extends JFrame {
	...
	JSlider zslice_slider, yslice_slider, xslice_slider; //sliders to step through the slices z and y directions) (remember 113 slices in z direction 0-112)
    ...
    */
    public void Example() throws IOException {
        ...
        image3 = new BufferedImage(112, 256, BufferedImage.TYPE_3BYTE_BGR);
        ...
        pane.add(zslice_slider);

        image_icon2 = new JLabel(new ImageIcon(image2));
        image_icon2.setSize(300, 300);
        pane.add(image_icon2);

        mip_button2 = new JButton("MIP2");
        pane.add(mip_button2);
        ...
        pane.add(yslice_slider);

        image_icon3 = new JLabel(new ImageIcon(image3));
        image_icon3.setSize(300, 300);
        pane.add(image_icon3);

        mip_button3 = new JButton("MIP3");
        pane.add(mip_button3);
    ...
    */
    ...
    public BufferedImage sliderMIP3(BufferedImage image) {
        ...
        for (j=0; j<h; j++) {
            for (i=0; i<w; i++) {
                datum=cthead[i][j][xslice_slider.getValue()];
                col=(255.0f*((float)datum-(float)min)/((float)(max-min)));
                for (c=0; c<3; c++) {
                    data[c+3*i+3*j*w]=(byte) col;
                }
